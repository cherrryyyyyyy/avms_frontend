<template>
    <div>
        ...
        <div class="wrapper">
            ...
            <el-header></el-header>
            <el-header></el-header>
            <el-table stripe=true :data="hostD[$route.query.result_id - 1]" height=480 border style="width: 100%">
                <el-table-column prop="host_name" label="主机" width="250" align="center" show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="host_OEM" label="厂商" width="250" align="center" show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="host_model" label="型号" width="250" align="center" show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="host_OS" label="操作系统" width="200" align="center" show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="host_open_ports" label="开放端口" width="150" align="center"
                    show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="host_hr_vul" label="高危漏洞" width="150" align="center"
                    show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="host_mr_vul" label="中危漏洞" width="150" align="center"
                    show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="host_lr_vul" label="低危漏洞" width="150" align="center"
                    show-overflow-tooltip="true">
                </el-table-column>
